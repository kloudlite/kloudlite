...
export const Disabled = () => (
  <Demo label="postgres &middot; managed service">
    <ContextMenuContent className="w-64">
      <ContextMenuItem>Copy connection string</ContextMenuItem>
      <ContextMenuItem disabled>Restart (managed by Kloudlite)</ContextMenuItem>
      <ContextMenuItem disabled>Delete service</ContextMenuItem>
    </ContextMenuContent>
  </Demo>
)
...
export const Inset = () => (
  <Demo label="Workload list">
    <ContextMenuContent className="w-64">
      ...
      <ContextMenuItem inset>Restart count</ContextMenuItem>
