    ...
    <Menubar defaultValue="environment">
      <MenubarMenu value="environment">
        ...
        <MenubarGroup>
          ...
          <MenubarItem>Open cluster dashboard</MenubarItem>
        </MenubarGroup>
        </MenubarContent>
      </MenubarMenu>
...
export const WideContent = () => (
  <Frame>
    <Menubar defaultValue="help">
      <MenubarMenu value="help">
        <MenubarTrigger>Help</MenubarTrigger>
        <MenubarContent className="w-64" style={{ width: 288 }}>
        <MenubarItem>Kloudlite documentation</MenubarItem>
        <MenubarItem>Keyboard shortcuts reference</MenubarItem>
        <MenubarSeparator />
        <MenubarItem>Report an issue&hellip;</MenubarItem>
        </MenubarContent>
      </MenubarMenu>
      <Rest omit="help" />
    </Menubar>
