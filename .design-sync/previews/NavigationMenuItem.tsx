...
export const PlainLinkItems = () => (
  ...
  <NavigationMenu>
    <NavigationMenuList>
      ...
      <NavigationMenuItem>
        <NavigationMenuLink className={topLinkClass}>Environments</NavigationMenuLink>
      </NavigationMenuItem>
      <NavigationMenuItem>
        <NavigationMenuLink className={topLinkClass}>Clusters</NavigationMenuLink>
      </NavigationMenuItem>
      <NavigationMenuItem>
        <NavigationMenuLink className={topLinkClass}>Team</NavigationMenuLink>
      </NavigationMenuItem>
