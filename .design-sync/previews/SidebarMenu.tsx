...
export const CompactRows = () => (
  ...
  >
    <Sidebar collapsible="none" className="h-full border-r">
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel>Recent deployments</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton isActive size="sm">gateway &middot; 4m ago</SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton size="sm">payments-api &middot; 1h ago</SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton size="sm">web-console &middot; 3h ago</SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
          </SidebarGroupContent>
        </SidebarGroup>
