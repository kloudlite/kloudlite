...
# To re-generate a bundle for another specific version without changing the standard operator, you can:
...
# To re-generate a bundle for other specific channels without changing the standard operator, you can:
...
# To re-generate a bundle for any other default channel without changing the default operator, you can:
...
# kloudlite.io/app-bundle:$VERSION and kloudlite.io/app-catalog:$VERSION.
IMAGE_TAG_BASE ?= kloudlite.io/koperator
...
# This is a requirement for 'operator-envtest.sh' in the test target.
...
generate: controller-gen ## Generate code containing DeepCopy, DeepCopyInto, and DeepCopyObject method implementations.
	#$(CONTROLLER_GEN) object:headerFile="hack/boilerplate.go.txt" paths="./lib/functions/...;./lib/templates/...;./lib/raw-json/...;./lib/conditions/...;./lib/harbor/...;./lib/operator/..."
