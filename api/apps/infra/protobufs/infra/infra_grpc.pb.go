...
const (
	...
	Infra_GetByokCluster_FullMethodName            = "/Infra/GetByokCluster"
...
func (c *infraClient) GetByokCluster(ctx context.Context, in *GetClusterIn, opts ...grpc.CallOption) (*GetClusterOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetClusterOut)
	err := c.cc.Invoke(ctx, Infra_GetByokCluster_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infraClient) EnsureGlobalVPNConnection(ctx context.Context, in *EnsureGlobalVPNConnectionIn, opts ...grpc.CallOption) (*EnsureGlobalVPNConnectionOut, error) {
	...
	err := c.cc.Invoke(ctx, Infra_EnsureGlobalVPNConnection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infraClient) GetClusterGatewayResource(ctx context.Context, in *GetClusterGatewayResourceIn, opts ...grpc.CallOption) (*GetClusterGatewayResourceOut, error) {
	...
	err := c.cc.Invoke(ctx, Infra_GetClusterGatewayResource_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Infra_GetByokCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Infra_GetByokCluster_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
