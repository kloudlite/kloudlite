...
func (c *kubeAgentClient) KubeApply(ctx context.Context, in *PayloadIn, opts ...grpc.CallOption) (*PayloadOut, error) {
	...
	out := new(PayloadOut)
	err := c.cc.Invoke(ctx, KubeAgent_KubeApply_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedKubeAgentServer must be embedded to have
...
func (UnimplementedKubeAgentServer) testEmbeddedByValue()                   {}
...
func RegisterKubeAgentServer(s grpc.ServiceRegistrar, srv KubeAgentServer) {
	// If the following call pancis, it indicates UnimplementedKubeAgentServer was
