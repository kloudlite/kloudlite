...
func (c *cIClient) CreateHarborProject(ctx context.Context, in *HarborProjectIn, opts ...grpc.CallOption) (*HarborProjectOut, error) {
	...
	err := c.cc.Invoke(ctx, CI_CreateHarborProject_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cIClient) DeleteHarborProject(ctx context.Context, in *HarborProjectIn, opts ...grpc.CallOption) (*HarborProjectOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HarborProjectOut)
	err := c.cc.Invoke(ctx, CI_DeleteHarborProject_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCIServer must be embedded to have
...
func RegisterCIServer(s grpc.ServiceRegistrar, srv CIServer) {
	// If the following call pancis, it indicates UnimplementedCIServer was
