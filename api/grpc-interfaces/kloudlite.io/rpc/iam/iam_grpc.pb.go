...
type IAMClient interface {
	...
	ConfirmMembership(ctx context.Context, in *InConfirmMembership, opts ...grpc.CallOption) (*OutConfirmMembership, error)
...
func (c *iAMClient) ConfirmMembership(ctx context.Context, in *InConfirmMembership, opts ...grpc.CallOption) (*OutConfirmMembership, error) {
	out := new(OutConfirmMembership)
...
type IAMServer interface {
	...
	ConfirmMembership(context.Context, *InConfirmMembership) (*OutConfirmMembership, error)
...
func (UnimplementedIAMServer) ConfirmMembership(context.Context, *InConfirmMembership) (*OutConfirmMembership, error) {
...
func _IAM_ConfirmMembership_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IAMServer).ConfirmMembership(ctx, req.(*InConfirmMembership))
	}
	return interceptor(ctx, in, info, handler)
}
