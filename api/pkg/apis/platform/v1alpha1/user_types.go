...
type UserSpec struct {
	...
	// Hashed password for credential-based authentication (generated by controller)
	// +optional
	Password string `json:"password,omitempty"`

	// Plain text password for setting/updating password (will be hashed by controller)
	// This field will be cleared after password is hashed
	// +optional
...
type UserStatus struct {
	...
	// Hash of the last processed passwordString (for change detection)
	// +optional
