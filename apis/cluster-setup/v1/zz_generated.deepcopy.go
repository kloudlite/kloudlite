...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitlabRunner) DeepCopyInto(out *GitlabRunner) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitlabRunner.
func (in *GitlabRunner) DeepCopy() *GitlabRunner {
	if in == nil {
		return nil
	}
	out := new(GitlabRunner)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KlOperators) DeepCopyInto(out *KlOperators) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KlOperators.
func (in *KlOperators) DeepCopy() *KlOperators {
	if in == nil {
		return nil
	}
	out := new(KlOperators)
...
func (in *ManagedClusterSpec) DeepCopyInto(out *ManagedClusterSpec) {
	*out = *in
	...
	out.KlOperators = in.KlOperators
	if in.CertManager != nil {
		in, out := &in.CertManager, &out.CertManager
		*out = new(CertManager)
		**out = **in
	}
	if in.GitlabRunner != nil {
		in, out := &in.GitlabRunner, &out.GitlabRunner
		*out = new(GitlabRunner)
		**out = **in
	}
	if in.Loki != nil {
