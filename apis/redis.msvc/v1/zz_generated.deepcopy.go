...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ACLAccountStatus) DeepCopyInto(out *ACLAccountStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACLAccountStatus.
func (in *ACLAccountStatus) DeepCopy() *ACLAccountStatus {
	if in == nil {
		return nil
	}
	out := new(ACLAccountStatus)
	in.DeepCopyInto(out)
	return out
}
