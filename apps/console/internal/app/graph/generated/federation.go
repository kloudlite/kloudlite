...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Build":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Build": %w`, err)
			}
			switch resolverName {
			...
			case "findBuildByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findBuildByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindBuildByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Build": %w`, err)
				}
...
func entityResolverNameForBuild(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
