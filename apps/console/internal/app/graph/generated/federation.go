...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Device":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Device": %w`, err)
			}
			switch resolverName {
			...
			case "findDeviceByID":
				id0, err := ec.unmarshalNID2kloudliteᚗioᚋpkgᚋreposᚐID(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findDeviceByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindDeviceByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Device": %w`, err)
				}
