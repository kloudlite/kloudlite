...
`, BuiltIn: false},
	{Name: "../crd-to-gql/config.graphqls", Input: `type Config {
	kind: String
	metadata: Metadata! @goField(name: "objectMeta")
	overrides: Overrides
	projectName: String
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/directives.graphqls", Input: `extend schema @link(url: "https://specs.apollo.dev/federation/v2.0", import: ["@key", "@shareable"])
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/managedresource.graphqls", Input: `type ManagedResourceSpecMsvcRef {
	kind: String
	name: String!
	apiVersion: String!
}
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/managedservice.graphqls", Input: `type ManagedServiceSpecMsvcKind {
	apiVersion: String!
	kind: String
}
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/project.graphqls", Input: `type ProjectSpec {
	accountName: String!
	displayName: String
	logo: String
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/router.graphqls", Input: `type RouterSpecBasicAuth {
	username: String
	enabled: Boolean!
	secretName: String
}
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/secret.graphqls", Input: `type Secret {
	syncStatus: SyncStatus
	data: Map
	enabled: Boolean
	kind: String
...
func (ec *executionContext) fieldContext_App_spec(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "accountName":
				return ec.fieldContext_AppSpec_accountName(ctx, field)
			}
...
func (ec *executionContext) _AppSpec_accountName(ctx context.Context, field graphql.CollectedField, obj *model.AppSpec) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_AppSpec_accountName(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_AppSpec_accountName(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "AppSpec",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) unmarshalInputAppIn(ctx context.Context, obj interface{}) (entities.App, error) {
	...
	fieldsInOrder := [...]string{"apiVersion", "enabled", "kind", "metadata", "overrides", "restart", "spec"}
...
func (ec *executionContext) unmarshalInputAppSpecContainersEnvIn(ctx context.Context, obj interface{}) (model.AppSpecContainersEnvIn, error) {
	...
	fieldsInOrder := [...]string{"key", "refKey", "refName", "type", "value"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecContainersIn(ctx context.Context, obj interface{}) (model.AppSpecContainersIn, error) {
	...
	fieldsInOrder := [...]string{"resourceCpu", "resourceMemory", "volumes", "args", "command", "envFrom", "image", "readinessProbe", "env", "imagePullPolicy", "livenessProbe", "name"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecContainersReadinessProbeIn(ctx context.Context, obj interface{}) (model.AppSpecContainersReadinessProbeIn, error) {
	...
	fieldsInOrder := [...]string{"type", "failureThreshold", "httpGet", "initialDelay", "interval", "shell", "tcp"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecIn(ctx context.Context, obj interface{}) (model.AppSpecIn, error) {
	...
	fieldsInOrder := [...]string{"region", "replicas", "serviceAccount", "containers", "freeze", "hpa", "intercept", "nodeSelector", "services", "tolerations", "accountName"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputConfigIn(ctx context.Context, obj interface{}) (entities.Config, error) {
	...
	fieldsInOrder := [...]string{"kind", "metadata", "overrides", "projectName", "apiVersion", "data", "enabled"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputManagedResourceSpecMsvcRefIn(ctx context.Context, obj interface{}) (model.ManagedResourceSpecMsvcRefIn, error) {
	...
	fieldsInOrder := [...]string{"kind", "name", "apiVersion"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputManagedServiceSpecIn(ctx context.Context, obj interface{}) (model.ManagedServiceSpecIn, error) {
	...
	fieldsInOrder := [...]string{"msvcKind", "nodeSelector", "region", "tolerations", "inputs"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputProjectSpecIn(ctx context.Context, obj interface{}) (model.ProjectSpecIn, error) {
	...
	fieldsInOrder := [...]string{"accountName", "displayName", "logo", "targetNamespace"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputRouterIn(ctx context.Context, obj interface{}) (entities.Router, error) {
	...
	fieldsInOrder := [...]string{"overrides", "spec", "apiVersion", "kind", "metadata"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputRouterSpecBasicAuthIn(ctx context.Context, obj interface{}) (model.RouterSpecBasicAuthIn, error) {
	...
	fieldsInOrder := [...]string{"username", "enabled", "secretName"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputRouterSpecIn(ctx context.Context, obj interface{}) (model.RouterSpecIn, error) {
	...
	fieldsInOrder := [...]string{"routes", "basicAuth", "cors", "domains", "https", "maxBodySizeInMB", "rateLimit", "region"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputSecretIn(ctx context.Context, obj interface{}) (entities.Secret, error) {
	...
	fieldsInOrder := [...]string{"data", "enabled", "kind", "projectName", "apiVersion", "metadata", "overrides", "stringData", "type"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) _AppSpec(ctx context.Context, sel ast.SelectionSet, obj *model.AppSpec) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "accountName":
			...
			out.Values[i] = ec._AppSpec_accountName(ctx, field, obj)
