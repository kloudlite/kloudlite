...
`, BuiltIn: false},
	{Name: "../crd-to-gql/app.graphqls", Input: `type AppSpecContainersResourceCpu @shareable {
	max: String
	min: String
}
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/managedservice.graphqls", Input: `input ManagedServiceSpecMsvcKindIn {
	apiVersion: String!
	kind: String
}
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/router.graphqls", Input: `input RouterSpecHttpsIn {
	enabled: Boolean!
...
func (ec *executionContext) unmarshalInputAppIn(ctx context.Context, obj interface{}) (entities.App, error) {
	...
	fieldsInOrder := [...]string{"enabled", "kind", "metadata", "overrides", "restart", "spec", "apiVersion"}
...
func (ec *executionContext) unmarshalInputAppSpecContainersEnvIn(ctx context.Context, obj interface{}) (model.AppSpecContainersEnvIn, error) {
	...
	fieldsInOrder := [...]string{"refName", "type", "value", "key", "refKey"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecContainersIn(ctx context.Context, obj interface{}) (model.AppSpecContainersIn, error) {
	...
	fieldsInOrder := [...]string{"args", "command", "env", "imagePullPolicy", "livenessProbe", "readinessProbe", "resourceCpu", "envFrom", "image", "name", "resourceMemory", "volumes"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecIn(ctx context.Context, obj interface{}) (model.AppSpecIn, error) {
	...
	fieldsInOrder := [...]string{"tolerations", "accountName", "containers", "region", "nodeSelector", "replicas", "serviceAccount", "services", "freeze", "hpa", "intercept"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecServicesIn(ctx context.Context, obj interface{}) (model.AppSpecServicesIn, error) {
	...
	fieldsInOrder := [...]string{"type", "name", "port", "targetPort"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputConfigIn(ctx context.Context, obj interface{}) (entities.Config, error) {
	...
	fieldsInOrder := [...]string{"enabled", "kind", "metadata", "overrides", "projectName", "apiVersion", "data"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputManagedServiceSpecIn(ctx context.Context, obj interface{}) (model.ManagedServiceSpecIn, error) {
	...
	fieldsInOrder := [...]string{"region", "tolerations", "inputs", "msvcKind", "nodeSelector"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputProjectSpecIn(ctx context.Context, obj interface{}) (model.ProjectSpecIn, error) {
	...
	fieldsInOrder := [...]string{"logo", "targetNamespace", "accountName", "clusterName", "displayName"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputRouterSpecBasicAuthIn(ctx context.Context, obj interface{}) (model.RouterSpecBasicAuthIn, error) {
	...
	fieldsInOrder := [...]string{"secretName", "username", "enabled"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputRouterSpecIn(ctx context.Context, obj interface{}) (model.RouterSpecIn, error) {
	...
	fieldsInOrder := [...]string{"https", "maxBodySizeInMB", "rateLimit", "region", "routes", "basicAuth", "cors", "domains"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputRouterSpecRoutesIn(ctx context.Context, obj interface{}) (model.RouterSpecRoutesIn, error) {
	...
	fieldsInOrder := [...]string{"lambda", "path", "port", "rewrite", "app"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputSecretIn(ctx context.Context, obj interface{}) (entities.Secret, error) {
	...
	fieldsInOrder := [...]string{"enabled", "kind", "type", "apiVersion", "metadata", "overrides", "projectName", "stringData", "data"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
