...
`, BuiltIn: false},
	{Name: "graph/crd-to-gql/app.graphqls", Input: `input AppSpecContainersReadinessProbeTcpIn {
	port: Int!
}
...
`, BuiltIn: false},
	{Name: "graph/crd-to-gql/managedresource.graphqls", Input: `input ManagedResourceSpecMresKindIn {
	kind: String!
}
