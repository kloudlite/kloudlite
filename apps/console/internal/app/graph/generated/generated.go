...
`, BuiltIn: false},
	{Name: "../crd-to-gql/app.graphqls", Input: `input AppSpecContainersLivenessProbeHttpGetIn {
	httpHeaders: Map
	path: String!
	port: Int!
}
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/managedresource.graphqls", Input: `input ManagedResourceSpecMresKindIn {
	kind: String!
}
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/managedservice.graphqls", Input: `input ManagedServiceSpecIn {
	inputs: Map
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/router.graphqls", Input: `type RouterSpecBasicAuth @shareable {
	enabled: Boolean!
	secretName: String
	username: String
}
...
func (ec *executionContext) unmarshalInputAppSpecContainersEnvIn(ctx context.Context, obj interface{}) (model.AppSpecContainersEnvIn, error) {
	...
	fieldsInOrder := [...]string{"refKey", "refName", "type", "value", "key", "optional"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecContainersIn(ctx context.Context, obj interface{}) (model.AppSpecContainersIn, error) {
	...
	fieldsInOrder := [...]string{"image", "imagePullPolicy", "livenessProbe", "resourceMemory", "volumes", "env", "envFrom", "name", "readinessProbe", "resourceCpu", "args", "command"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecIn(ctx context.Context, obj interface{}) (model.AppSpecIn, error) {
	...
	fieldsInOrder := [...]string{"region", "replicas", "freeze", "hpa", "intercept", "serviceAccount", "services", "tolerations", "containers", "displayName", "nodeSelector"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputManagedServiceIn(ctx context.Context, obj interface{}) (entities.MSvc, error) {
	...
	fieldsInOrder := [...]string{"enabled", "kind", "metadata", "overrides", "spec", "apiVersion"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputManagedServiceSpecTolerationsIn(ctx context.Context, obj interface{}) (model.ManagedServiceSpecTolerationsIn, error) {
	...
	fieldsInOrder := [...]string{"tolerationSeconds", "value", "effect", "key", "operator"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputRouterSpecIn(ctx context.Context, obj interface{}) (model.RouterSpecIn, error) {
	...
	fieldsInOrder := [...]string{"routes", "backendProtocol", "basicAuth", "domains", "https", "region", "cors", "ingressClass", "maxBodySizeInMB", "rateLimit"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputSecretIn(ctx context.Context, obj interface{}) (entities.Secret, error) {
	...
	fieldsInOrder := [...]string{"data", "enabled", "overrides", "projectName", "stringData", "type", "apiVersion", "metadata", "kind"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
