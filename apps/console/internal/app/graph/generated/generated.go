...
`, BuiltIn: false},
	{Name: "../crd-to-gql/app.graphqls", Input: `type AppSpecContainersVolumes @shareable {
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/environment.graphqls", Input: `type EnvironmentSpec @shareable {
	projectName: String!
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/router.graphqls", Input: `type RouterSpec @shareable {
	region: String
...
func (ec *executionContext) unmarshalInputAppSpecContainersEnvIn(ctx context.Context, obj interface{}) (model.AppSpecContainersEnvIn, error) {
	...
	fieldsInOrder := [...]string{"type", "value", "key", "optional", "refKey", "refName"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecContainersIn(ctx context.Context, obj interface{}) (model.AppSpecContainersIn, error) {
	...
	fieldsInOrder := [...]string{"command", "readinessProbe", "volumes", "args", "env", "envFrom", "image", "imagePullPolicy", "livenessProbe", "name", "resourceCpu", "resourceMemory"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecContainersReadinessProbeHttpGetIn(ctx context.Context, obj interface{}) (model.AppSpecContainersReadinessProbeHTTPGetIn, error) {
	...
	fieldsInOrder := [...]string{"port", "httpHeaders", "path"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecContainersReadinessProbeIn(ctx context.Context, obj interface{}) (model.AppSpecContainersReadinessProbeIn, error) {
	...
	fieldsInOrder := [...]string{"httpGet", "initialDelay", "interval", "shell", "tcp", "type", "failureThreshold"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecIn(ctx context.Context, obj interface{}) (model.AppSpecIn, error) {
	...
	fieldsInOrder := [...]string{"containers", "hpa", "services", "serviceAccount", "tolerations", "displayName", "freeze", "intercept", "nodeSelector", "region", "replicas"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputAppSpecTolerationsIn(ctx context.Context, obj interface{}) (model.AppSpecTolerationsIn, error) {
	...
	fieldsInOrder := [...]string{"operator", "tolerationSeconds", "value", "effect", "key"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputConfigIn(ctx context.Context, obj interface{}) (entities.Config, error) {
	...
	fieldsInOrder := [...]string{"overrides", "apiVersion", "data", "enabled", "kind", "metadata"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputManagedServiceSpecIn(ctx context.Context, obj interface{}) (model.ManagedServiceSpecIn, error) {
	...
	fieldsInOrder := [...]string{"nodeSelector", "region", "tolerations", "inputs", "msvcKind"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputRouterSpecIn(ctx context.Context, obj interface{}) (model.RouterSpecIn, error) {
	...
	fieldsInOrder := [...]string{"region", "routes", "backendProtocol", "basicAuth", "domains", "ingressClass", "rateLimit", "cors", "https", "maxBodySizeInMB"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputRouterSpecRateLimitIn(ctx context.Context, obj interface{}) (model.RouterSpecRateLimitIn, error) {
	...
	fieldsInOrder := [...]string{"rps", "connections", "enabled", "rpm"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputRouterSpecRoutesIn(ctx context.Context, obj interface{}) (model.RouterSpecRoutesIn, error) {
	...
	fieldsInOrder := [...]string{"rewrite", "app", "lambda", "path", "port"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputSecretIn(ctx context.Context, obj interface{}) (entities.Secret, error) {
	...
	fieldsInOrder := [...]string{"kind", "projectName", "type", "stringData", "apiVersion", "data", "enabled", "metadata", "overrides"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
