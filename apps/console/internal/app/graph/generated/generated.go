...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Router.defaultDomain":
		if e.complexity.Router.DefaultDomain == nil {
			break
		}

		return e.complexity.Router.DefaultDomain(childComplexity), true
...
func (ec *executionContext) _Router_defaultDomain(ctx context.Context, field graphql.CollectedField, obj *model.Router) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Router(ctx context.Context, sel ast.SelectionSet, obj *model.Router) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "defaultDomain":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Router_defaultDomain(ctx, field, obj)
			}
