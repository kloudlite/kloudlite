...
//	}
//
//	d.resourceEventPublisher.PublishEnvironmentResourceEvent(ctx, pms.ProjectName, entities.ResourceTypeProjectManagedService, pms.Name, PublishAdd)
//
//	return pms, nil
//}
//
...
//	}
//
//	d.resourceEventPublisher.PublishEnvironmentResourceEvent(ctx, upmsvc.ProjectName, entities.ResourceTypeProjectManagedService, service.Name, PublishUpdate)
//
...
//	}
//
//	d.resourceEventPublisher.PublishEnvironmentResourceEvent(ctx, upmsvc.ProjectName, entities.ResourceTypeProjectManagedService, name, PublishUpdate)
//
...
//	}
//
//	d.resourceEventPublisher.PublishEnvironmentResourceEvent(ctx, upmsvc.ProjectName, entities.ResourceTypeProjectManagedService, upmsvc.Name, PublishDelete)
//
//	return errors.NewE(err)
//}
//
...
//		return errors.NewE(err)
//	}
//	d.resourceEventPublisher.PublishEnvironmentResourceEvent(ctx, projectName, entities.ResourceTypeProjectManagedService, service.Name, PublishDelete)
//	return nil
//}
//
...
//	}
//
//	d.resourceEventPublisher.PublishEnvironmentResourceEvent(ctx, upmsvc.ProjectName, entities.ResourceTypeProjectManagedService, upmsvc.Name, PublishUpdate)
//
//	return nil
//}
//
