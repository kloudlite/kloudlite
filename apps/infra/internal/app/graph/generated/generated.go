...
`, BuiltIn: false},
	{Name: "../crd-to-gql/cluster.graphqls", Input: `type ClusterSpec {
	accountName: String!
	config: String!
	count: Int!
	provider: String!
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/edge.graphqls", Input: `type EdgeSpec {
	clusterName: String!
	pools: [EdgeSpecPools]
	provider: String
	providerName: String!
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/masternode.graphqls", Input: `type MasterNodeSpec {
	accountName: String!
	clusterName: String!
	config: String!
	provider: String!
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/nodepool.graphqls", Input: `type NodePool {
	status: Status
	apiVersion: String
	kind: String
	metadata: Metadata! @goField(name: "objectMeta")
...
`, BuiltIn: false},
	{Name: "../crd-to-gql/workernode.graphqls", Input: `type WorkerNode {
	metadata: Metadata! @goField(name: "objectMeta")
	syncStatus: SyncStatus
	spec: WorkerNodeSpec
	status: Status
...
func (ec *executionContext) unmarshalInputNodePoolSpecIn(ctx context.Context, obj interface{}) (model.NodePoolSpecIn, error) {
	...
	fieldsInOrder := [...]string{"providerName", "accountName", "clusterName", "config", "min", "provider", "edgeName", "max", "region"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputSecretIn(ctx context.Context, obj interface{}) (entities.Secret, error) {
	...
	fieldsInOrder := [...]string{"apiVersion", "kind", "stringData", "data", "enabled", "metadata", "overrides", "projectName", "type"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputWorkerNodeSpecIn(ctx context.Context, obj interface{}) (model.WorkerNodeSpecIn, error) {
	...
	fieldsInOrder := [...]string{"provider", "providerName", "stateful", "accountName", "edgeName", "nodeIndex", "pool", "region", "clusterName", "config"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
