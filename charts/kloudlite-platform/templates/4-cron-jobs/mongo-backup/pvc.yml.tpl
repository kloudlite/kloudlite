...
spec:
  ...
  capacity:
    storage: "{{.Values.crons.mongoBackup.storageSize}}"
  accessModes:
    - ReadWriteMany
  claimRef:
    namespace: "{{.Release.Namespace}}"
  ...
  csi:
    ...
    volumeAttributes:
      capacity: "{{.Values.crons.mongoBackup.storageSize}}"
      mounter: geesefs
      options: --memory-limit 1000 --dir-mode 0777 --file-mode 0666

    volumeHandle: {{.Values.csiS3.s3.bucketName}}/{{.Values.crons.mongoBackup.name}}
