...
import (
	...
	"github.com/kloudlite/kloudlite/cli/kli/internal/console"
	k8sinternal "github.com/kloudlite/kloudlite/cli/kli/internal/k8s"
	ociinternal "github.com/kloudlite/kloudlite/cli/kli/internal/oci"
)
...
func runInstall(ctx context.Context, cfg *Config) error {
	...
	nextStep := func(desc string) {
		...
		reportProgress(cfg, "install", step, totalSteps, desc)
	}
