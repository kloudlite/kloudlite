...
func (r *{{$reconType}}) finalize(req *rApi.Request[*mongodbMsvcv1.Database]) stepResult.Result {
	return req.Finalize()
}

func (r *{{$reconType}}) reconOwnership(req *rApi.Request[*mongodbMsvcv1.Database]) stepResult.Result {
...
func (r *{{$reconType}}) reconDBCreds(req *rApi.Request[*mongodbMsvcv1.Database]) stepResult.Result {
	ctx, obj, checks := req.Context(), req.Object, req.Object.Status.Checks
	check := rApi.Check{Generation: obj.Generation}
...
func (r *{{$reconType}}) reconDBUser(req *rApi.Request[*mongodbMsvcv1.Database]) stepResult.Result {
	ctx, obj, checks := req.Context(), req.Object, req.Object.Status.Checks
	check := rApi.Check{Generation: obj.Generation}
