...
type MessageDispatchServiceClient interface {
	...
	ReceiveContainerRegistryUpdates(ctx context.Context, opts ...grpc.CallOption) (MessageDispatchService_ReceiveContainerRegistryUpdatesClient, error)
...
func (c *messageDispatchServiceClient) ValidateAccessToken(ctx context.Context, in *ValidateAccessTokenIn, opts ...grpc.CallOption) (*ValidateAccessTokenOut, error) {
	...
	err := c.cc.Invoke(ctx, "/MessageDispatchService/ValidateAccessToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageDispatchServiceClient) ReceiveContainerRegistryUpdates(ctx context.Context, opts ...grpc.CallOption) (MessageDispatchService_ReceiveContainerRegistryUpdatesClient, error) {
	stream, err := c.cc.NewStream(ctx, &MessageDispatchService_ServiceDesc.Streams[4], "/MessageDispatchService/ReceiveContainerRegistryUpdates", opts...)
	if err != nil {
		return nil, err
	}
	x := &messageDispatchServiceReceiveContainerRegistryUpdatesClient{stream}
	return x, nil
}

type MessageDispatchService_ReceiveContainerRegistryUpdatesClient interface {
	Send(*ContainerRegistryUpdate) error
	CloseAndRecv() (*Empty, error)
	grpc.ClientStream
}

type messageDispatchServiceReceiveContainerRegistryUpdatesClient struct {
	grpc.ClientStream
}

func (x *messageDispatchServiceReceiveContainerRegistryUpdatesClient) Send(m *ContainerRegistryUpdate) error {
	return x.ClientStream.SendMsg(m)
}

func (x *messageDispatchServiceReceiveContainerRegistryUpdatesClient) CloseAndRecv() (*Empty, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Empty)
...
func (c *messageDispatchServiceClient) ReceiveClusterUpdates(ctx context.Context, opts ...grpc.CallOption) (MessageDispatchService_ReceiveClusterUpdatesClient, error) {
	stream, err := c.cc.NewStream(ctx, &MessageDispatchService_ServiceDesc.Streams[5], "/MessageDispatchService/ReceiveClusterUpdates", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *messageDispatchServiceClient) Ping(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PingOutput, error) {
	out := new(PingOutput)
	err := c.cc.Invoke(ctx, "/MessageDispatchService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MessageDispatchServiceServer interface {
	...
	ReceiveContainerRegistryUpdates(MessageDispatchService_ReceiveContainerRegistryUpdatesServer) error
...
func (UnimplementedMessageDispatchServiceServer) ReceiveContainerRegistryUpdates(MessageDispatchService_ReceiveContainerRegistryUpdatesServer) error {
	return status.Errorf(codes.Unimplemented, "method ReceiveContainerRegistryUpdates not implemented")
}
...
func _MessageDispatchService_ValidateAccessToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MessageDispatchService/ValidateAccessToken",
	}
...
func _MessageDispatchService_ReceiveContainerRegistryUpdates_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(MessageDispatchServiceServer).ReceiveContainerRegistryUpdates(&messageDispatchServiceReceiveContainerRegistryUpdatesServer{stream})
}

type MessageDispatchService_ReceiveContainerRegistryUpdatesServer interface {
	SendAndClose(*Empty) error
	Recv() (*ContainerRegistryUpdate, error)
	grpc.ServerStream
}

type messageDispatchServiceReceiveContainerRegistryUpdatesServer struct {
	grpc.ServerStream
}

func (x *messageDispatchServiceReceiveContainerRegistryUpdatesServer) SendAndClose(m *Empty) error {
	return x.ServerStream.SendMsg(m)
}

func (x *messageDispatchServiceReceiveContainerRegistryUpdatesServer) Recv() (*ContainerRegistryUpdate, error) {
	m := new(ContainerRegistryUpdate)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func _MessageDispatchService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MessageDispatchService/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var MessageDispatchService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ReceiveContainerRegistryUpdates",
			Handler:       _MessageDispatchService_ReceiveContainerRegistryUpdates_Handler,
			ClientStreams: true,
		},
		{
