...
type PipelineIn struct {
	...
	GithubInstallationId string            `protobuf:"bytes,8,opt,name=GithubInstallationId,proto3" json:"GithubInstallationId,omitempty"`
...
func (x *PipelineIn) GetGithubInstallationId() string {
	if x != nil {
...
var file_ci_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x14, 0x47,
