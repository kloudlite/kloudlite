...
func (x *CreateClusterIn) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateClusterIn) ProtoMessage() {}

func (x *CreateClusterIn) ProtoReflect() protoreflect.Message {
	mi := &file_console_proto_msgTypes[0]
...
// Deprecated: Use CreateClusterIn.ProtoReflect.Descriptor instead.
func (*CreateClusterIn) Descriptor() ([]byte, []int) {
	return file_console_proto_rawDescGZIP(), []int{0}
}

func (x *CreateClusterIn) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
func (x *CreateClusterIn) GetAccountName() string {
	if x != nil {
...
func (x *CreateClusterOut) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateClusterOut) ProtoMessage() {}

func (x *CreateClusterOut) ProtoReflect() protoreflect.Message {
	mi := &file_console_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateClusterOut.ProtoReflect.Descriptor instead.
func (*CreateClusterOut) Descriptor() ([]byte, []int) {
	return file_console_proto_rawDescGZIP(), []int{1}
}

func (x *CreateClusterOut) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
var file_console_proto_rawDesc = []byte{
	...
	0x51, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	...
	,
...
var file_console_proto_goTypes = []interface{}{
	(*CreateClusterIn)(nil),  // 0: CreateClusterIn
	(*CreateClusterOut)(nil), // 1: CreateClusterOut
}
var file_console_proto_depIdxs = []int32{
	0, // 0: Console.CreateDefaultCluster:input_type -> CreateClusterIn
	1, // 1: Console.CreateDefaultCluster:output_type -> CreateClusterOut
