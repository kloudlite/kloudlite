...
type K3sRunnerConfig struct {
	// KloudliteAccount string `json:"kloudlite_account"`
	// KloudliteCluster string `json:"kloudlite_cluster"`
	// ClusterToken     string `json:"cluster_token"`

	K3sFlags []string `json:"k3s_flags"`
}
