...
func (r *Reconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	reconciler.ReconcileSteps(req, []reconciler.Step[*v1.Router]{
		{
			Enabled:  req.Object.Spec.BasicAuth != nil && req.Object.Spec.BasicAuth.Enabled,
...
func (r *Reconciler) setupBasicAuth(check *reconciler.Check[*v1.Router], obj *v1.Router) reconciler.StepResult {
	...
	basicAuthScrt := &corev1.Secret{ObjectMeta: metav1.ObjectMeta{
		Name:      obj.Spec.BasicAuth.SecretName,
		Namespace: obj.Namespace,
	}, Type: "Opaque"}

	if _, err := controllerutil.CreateOrUpdate(check.Context(), r.Client, basicAuthScrt, func() error {
...
func (r *Reconciler) cleanupBasicAuth(check *reconciler.Check[*v1.Router], obj *v1.Router) reconciler.StepResult {
	...
	if err := fn.DeleteAndWait(check.Context(), r.Client, basicAuthScrt); err != nil {
		return check.Failed(err)
	}
