...
const (
	...
	MessageDispatchService_ReceiveResourceUpdate_FullMethodName           = "/MessageDispatchService/ReceiveResourceUpdate"
...
type MessageDispatchServiceClient interface {
	...
	ReceiveResourceUpdate(ctx context.Context, in *ResourceUpdate, opts ...grpc.CallOption) (*Empty, error)
...
func (c *messageDispatchServiceClient) ReceiveResourceUpdate(ctx context.Context, in *ResourceUpdate, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, MessageDispatchService_ReceiveResourceUpdate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MessageDispatchServiceServer interface {
	...
	ReceiveResourceUpdate(context.Context, *ResourceUpdate) (*Empty, error)
...
func (UnimplementedMessageDispatchServiceServer) ReceiveResourceUpdate(context.Context, *ResourceUpdate) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReceiveResourceUpdate not implemented")
}
...
func _MessageDispatchService_ReceiveResourceUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResourceUpdate)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MessageDispatchServiceServer).ReceiveResourceUpdate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageDispatchService_ReceiveResourceUpdate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageDispatchServiceServer).ReceiveResourceUpdate(ctx, req.(*ResourceUpdate))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MessageDispatchService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReceiveResourceUpdate",
			Handler:    _MessageDispatchService_ReceiveResourceUpdate_Handler,
		},
		{
