...
| `image.tag`              | MongoDB(&reg;) image tag (immutable tags are recommended)                                                                       | `5.0.8-debian-10-r10`  |
...
| `tls.enabled`            | Enable MongoDB(&reg;) TLS support between nodes in the cluster as well as between mongox clients and nodes                       | `false`                |
...
| `tls.image.tag`          | Init container TLS certs setup image tag (immutable tags are recommended)                                                       | `1.21.6-debian-10-r93` |
...
| `externalAccess.autoDiscovery.image.tag`                 | Init container auto-discovery image tag (immutable tags are recommended)                                                                        | `1.23.6-debian-10-r8` |
...
| `metrics.image.tag`                          | MongoDB(&reg;) Prometheus exporter image tag (immutable tags are recommended)                                         | `0.32.0-debian-10-r3`      |
...
In the example below, you can find how to use a example here for a [MongoDB replica set pod labeler sidecar](https://github.com/combor/k8s-mongox-labeler-sidecar) to identify the primary pod and dynamically label it as the primary node:
