...
import (
	...
	"github.com/kloudlite/operator/internal/resource_watcher/internal/types"
...
func (r *Reconciler) dispatchEvent(ctx Context, obj *unstructured.Unstructured) error {
	if r.MsgSender == nil {
	...
	gvk := fn.ParseGVK(obj.GetAPIVersion(), obj.GetKind())

	switch gvk.String() {
	case AppGVK.String(),
		EnvironmentGVK.String(),
		RouterGVK.String(),
		ConfigmapGVK.String(),
		SecretGVK.String(),
		HelmChartGVK.String(),
		HelmPipelineGVK.String():
		{
			return r.MsgSender.DispatchResourceUpdates(ctx, t.ResourceUpdate{Object: obj})
		}
	...
	// 			ctx.Logger.Info(fmt.Sprintf("mres secret for resource (%s), not found", obj.GetName()))
	// 			mresSecret = nil
	// 		}
	//
	// 		if mresSecret != nil {
	...
	// 		}
	//
	// 		return r.MsgSender.DispatchConsoleResourceUpdates(ctx, t.ResourceUpdate{
	// 			Object: obj,
	// 		})
	// 	}
	...
	// 			return r.MsgSender.DispatchInfraResourceUpdates(ctx, t.ResourceUpdate{
	// 				Object: obj,
	// 			})
	// 		}
	//
	...
	default:
		{
			r.logger.Info(fmt.Sprintf("message sender is not configured for resource (%s), gvk=(%s). Ignoring resource update", fmt.Sprintf(obj.GetNamespace(), obj.GetName()), obj.GetObjectKind().GroupVersionKind().String()))
			return nil
		}
	}
}

func (r *Reconciler) SendResourceEvents(ctx Context, obj *unstructured.Unstructured) (ctrl.Result, error) {
...
func (r *Reconciler) Reconcile(ctx context.Context, oReq ctrl.Request) (ctrl.Result, error) {
	if r.MsgSender == nil {
		r.logger.Info("message-sender is nil")
	...
	if err != nil {
		r.logger.Error(fmt.Sprintf("badly formatted group-version-kind received, aborting ...", "GVK", wName.Group))
		return ctrl.Result{}, nil
	}
	...
	logger := r.logger.With("NN", fn.NN(oReq.Namespace, wName.Name).String(), "gvk", gvk.String())
	...
	obj, err := reconciler.Get(ctx, r.Client, fn.NN(oReq.Namespace, wName.Name), fn.NewUnstructured(tm))
	if err != nil {
		return ctrl.Result{}, client.IgnoreNotFound(err)
	}

	return r.SendResourceEvents(Context{ctx, logger}, obj)
}
...
var (
	EnvironmentGVK     = fn.ParseGVK("kloudlite.io/v1", "Environment")
	AppGVK             = fn.ParseGVK("kloudlite.io/v1", "App")
	PlatformServiceGVK = fn.ParseGVK("kloudlite.io/v1", "PlatformService")
	RouterGVK          = fn.ParseGVK("kloudlite.io/v1", "Router")

	WorkMachineGVK      = fn.ParseGVK("kloudlite.io/v1", "Workmachine")
	WorkspaceGVK        = fn.ParseGVK("kloudlite.io/v1", "Workspace")
	ServiceInterceptGVK = fn.ParseGVK("kloudlite.io/v1", "ServiceIntercept")

	HelmChartGVK    = fn.ParseGVK("plugin-helm-chart.kloudlite.github.com/v1", "HelmChart")
	HelmPipelineGVK = fn.ParseGVK("plugin-helm-chart.kloudlite.github.com/v1", "HelmPipeline")

	SecretGVK    = fn.ParseGVK("v1", "Secret")
	ConfigmapGVK = fn.ParseGVK("v1", "ConfigMap")
	NamespaceGVK = fn.ParseGVK("v1", "Namespace")

	// ExternalAppGVK = fn.ParseGVK("crds.kloudlite.io/v1", "ExternalApp")

	// ManagedServiceGVK = fn.ParseGVK("crds.kloudlite.io/v1", "ManagedService")
	// BlueprintGVK       = fn.ParseGVK("crds.kloudlite.io/v1", "Blueprint")

	// ManagedResourceGVK = fn.ParseGVK("crds.kloudlite.io/v1", "ManagedResource")
	// RouterGVK          = fn.ParseGVK("crds.kloudlite.io/v1", "Router")

	// NodePoolGVK        = fn.ParseGVK("clusters.kloudlite.io/v1", "NodePool")

	// DeviceGVK          = fn.ParseGVK("wireguard.kloudlite.io/v1", "Device")
	// GlobalVPNGVK       = fn.ParseGVK("wireguard.kloudlite.io/v1", "GlobalVPN")

	// GatewayGVK        = fn.ParseGVK("networking.kloudlite.io/v1", "Gateway")
	// ServiceBindingGVK = fn.ParseGVK("networking.kloudlite.io/v1", "ServiceBinding")
	//
	// // BuildRunGVK              = fn.ParseGVK("distribution.kloudlite.io/v1", "BuildRun")
	//
	// ClusterManagedServiceGVK = fn.ParseGVK("crds.kloudlite.io/v1", "ClusterManagedService")
	// // HelmChartGVK             = fn.ParseGVK("plugin-helm-chart.kloudlite.github.com/v1", "HelmChart")
	// ProjectManageServiceGVK = fn.ParseGVK("crds.kloudlite.io/v1", "ProjectManagedService")

	// native resources
	// PersistentVolumeClaimGVK = fn.ParseGVK("v1", "PersistentVolumeClaim")
	// PersistentVolumeGVK      = fn.ParseGVK("v1", "PersistentVolume")
	// VolumeAttachmentGVK      = fn.ParseGVK("storage.k8s.io/v1", "VolumeAttachment")
	// IngressGVK               = fn.ParseGVK("networking.k8s.io/v1", "Ingress")

	// SecretGVK    = fn.ParseGVK("v1", "Secret")
	// ConfigmapGVK = fn.ParseGVK("v1", "ConfigMap")
	// NamespaceGVK = fn.ParseGVK("v1", "Namespace")
	//
	// WorkMachineGVK = fn.ParseGVK("crds.kloudlite.io/v1", "WorkMachine")
	// WorkspaceGVK   = fn.ParseGVK("crds.kloudlite.io/v1", "Workspace")
)
...
func (r *Reconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	watchList := []schema.GroupVersionKind{
		EnvironmentGVK,
		AppGVK,
		RouterGVK,
		PlatformServiceGVK,
	...
	mgr.Add(manager.RunnableFunc(func(ctx context.Context) error {
		ms, err := NewGRPCMessageSender(ctx, &r.env)
		if err != nil {
			return err
		}
