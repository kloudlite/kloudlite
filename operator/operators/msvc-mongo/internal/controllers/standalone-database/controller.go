...
func (r *Reconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	req, err := rApi.NewRequest(rApi.NewReconcilerCtx(ctx, r.logger), r.Client, request.NamespacedName, &mongov1.StandaloneDatabase{})
	if err != nil {
...
func (r *Reconciler) createDBCreds(req *rApi.Request[*mongov1.StandaloneDatabase]) stepResult.Result {
	ctx, obj := req.Context(), req.Object
	...
	so, err := fn.ParseFromSecretData[types.StandaloneSvcOutput](msvcCreds.Data)
	if err != nil {
		check.Failed(err)
	}
...
func (r *Reconciler) createDBUserLifecycle(req *rApi.Request[*mongov1.StandaloneDatabase]) stepResult.Result {
	ctx, obj := req.Context(), req.Object
...
func (r *Reconciler) SetupWithManager(mgr ctrl.Manager, logger logging.Logger) error {
	...
	builder := ctrl.NewControllerManagedBy(mgr).For(&mongov1.StandaloneDatabase{})
