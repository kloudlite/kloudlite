...
import (
	...
	workspaceController "github.com/kloudlite/operator/operators/project/internal/controllers/workspace"
...
func main() {
	...
	mgr.RegisterControllers(
		...
		&workspaceController.Reconciler{Name: "workspace", Env: ev},
