...
export const metadata: Metadata = {
  title: "Development environments as a Service",
        ...
        <div className="container mx-auto px-6">
          <div className="flex h-20 items-center justify-between">
            <Link href="/" className="flex items-center transition-opacity hover:opacity-80">
              <svg height="22" viewBox="0 0 628 131" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5.5 w-auto">
        ...
        <div className="container mx-auto">
          <div className="mx-auto max-w-3xl space-y-8 text-center">
            <div className="space-y-4">
              <h1 className="text-4xl font-extralight tracking-tight text-foreground/90 sm:text-5xl md:text-6xl lg:text-7xl">
                Development environments
              </h1>
              <p className="text-2xl font-light text-primary sm:text-3xl md:text-4xl">
                as a Service
              </p>
            </div>
            
            <p className="mx-auto max-w-xl text-base leading-relaxed text-muted-foreground md:text-lg">
              Instant, production-grade development environments powered by Kubernetes. 
              Code, build, and deploy without limits.
            </p>
            
            <div className="flex flex-col items-center justify-center gap-4 pt-4 sm:flex-row">
              <Button 
                size="lg" 
                className="group min-w-[200px] shadow-sm hover:shadow-md transition-all duration-200" 
                asChild
              >
                <Link href="/auth/signup">
                  Start building
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="min-w-[200px] border-muted-foreground/20 hover:border-muted-foreground/40" 
                asChild
              >
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            ...
            <div className="flex items-center gap-6">
              <span className="text-sm text-muted-foreground">© 2024 Kloudlite</span>
              <ThemeToggle />
            </div>
          </div>
        </div>
