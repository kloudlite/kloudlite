...
Invoke-WebRequest -Uri "${baseUrl}/api/download/kli/windows-arm64" -OutFile "kli.exe"`}</code>
        ...
        <div className="bg-white shadow  p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a
              ...
              className="block p-4 border border-gray-300 hover:bg-gray-50 transition"
            >
        ...
        <div className="bg-white shadow  p-6 mb-8">
          ...
          <pre className="bg-gray-900 text-gray-100 p-4 overflow-x-auto mb-4">
            <code>{`# Check version
kli version
...
kli aws uninstall --installation-key myenv`}</code>
        ...
        <div className="bg-white shadow  p-6">
          ...
          <a
            ...
            className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium  text-white bg-blue-600 hover:bg-blue-700"
            target="_blank"
            rel="noopener noreferrer"
          >
