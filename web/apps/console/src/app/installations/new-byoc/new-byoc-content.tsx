...
interface NewByocContentProps {
  orgId: string
}

export function NewByocContent({ orgId }: NewByocContentProps) {
  return (
        ...
        <div className="sticky top-6 space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">Bring your own Cloud selected</p>
                </div>
              </div>
              <div className="flex gap-3">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">Run CLI commands and verify deployment</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border border-foreground/10 rounded-lg p-6 bg-background">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                <span className="text-primary mt-0.5">&bull;</span>
                <span>You&apos;ll need your cloud provider CLI configured</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="space-y-6 lg:flex-1 lg:min-w-0">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            Deploy Kloudlite in your own cloud account
          </p>
        </div>
        ...
        <div className="border border-foreground/10 rounded-lg bg-background">
          <div className="p-8">
            <InstallationForm
              hostingType="byoc"
              redirectTo="/installations/new/install"
              orgId={orgId}
            />
          </div>
        </div>
