...
import { Button, Input, Form, FormControl, FormField, FormItem, FormLabel, FormMessage, FormDescription, Card, CardContent, CardDescription, CardHeader, CardTitle } from '@kloudlite/ui'
...
interface ConfigureDomainContentProps {
  orgId: string
}

export function ConfigureDomainContent({ orgId }: ConfigureDomainContentProps) {
