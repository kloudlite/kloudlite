...
echo -e "\\033[0;32mUninstalling...\\033[0m"
kli uninstall aws \${REGION:+--region "$REGION"} --key "$KEY"
...
curl -fsSL "https://get.khost.dev/api/download/kli/linux-amd64" -o /usr/local/bin/kli && chmod +x /usr/local/bin/kli
echo -e "\\033[0;32mUninstalling...\\033[0m"
kli uninstall azure \${LOC:+--location "$LOC"} --key "$KEY"
echo -e "\\033[0;32mDone\\033[0m"`,
  'gcp': `#!/bin/bash
set -e
KEY=""; REGION=""; LOC=""; ZONE=""
...
curl -fsSL "https://get.khost.dev/api/download/kli/linux-amd64" -o /usr/local/bin/kli && chmod +x /usr/local/bin/kli
echo -e "\\033[0;32mUninstalling...\\033[0m"
kli uninstall gcp \${REGION:+--region "$REGION"} \${ZONE:+--zone "$ZONE"} --key "$KEY"
echo -e "\\033[0;32mDone\\033[0m"`,
}
