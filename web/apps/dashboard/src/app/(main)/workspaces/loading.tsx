    ...
    <main className="mx-auto max-w-7xl px-6 py-8">
      ...
      <div className="mb-8">
        <div className="mb-6">
          ...
          <div className="bg-muted mt-1.5 h-4 w-96 animate-pulse rounded" />
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              {/* Status Filter (wider - has more options) */}
              <div className="bg-muted flex h-9 w-56 animate-pulse items-center gap-1 rounded-md" />
              {/* Count */}
