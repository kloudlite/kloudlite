...
import { Button, Tabs, TabsContent, TabsList, TabsTrigger, Alert, AlertDescription } from '@kloudlite/ui'
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="sm" onClick={() => router.push('/admin/machine-configs')}>
