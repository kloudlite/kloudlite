...
import type { MachineType, WorkMachine } from '@kloudlite/lib/k8s'
...
export default async function UsersPage() {
  ...
  const machineTypeItems = (machineTypesResult.success && machineTypesResult.data
  ...
  const workMachines = isCloud && workMachinesResult.success && workMachinesResult.data
    ? (workMachinesResult.data as WorkMachine[])
    : []
