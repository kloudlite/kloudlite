...
const api: ElectronAPI = {
  ...
  deleteWorkspace: (namespace, name) => ipcRenderer.invoke('api:delete-workspace', namespace, name),
  listResources: (namespace, resource) => ipcRenderer.invoke('api:list-resources', namespace, resource),
  createResource: (namespace, resource, object) => ipcRenderer.invoke('api:create-resource', namespace, resource, object),
  deleteResource: (namespace, resource, name) => ipcRenderer.invoke('api:delete-resource', namespace, resource, name),
