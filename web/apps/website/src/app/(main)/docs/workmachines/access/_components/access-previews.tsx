  ...
  return (
    <PreviewFrame>
      <div className="text-xs">
        ...
        <div className="relative">
          {/* Dropdown overlay */}
          {showDropdown && !showConnected && (
            <div className="absolute top-2 right-4 w-72 border bg-background shadow-xl z-10 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          {/* Connected state */}
          {showConnected && (
            <div className="absolute top-2 right-4 w-64 border bg-background shadow-xl z-10 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <div className="m-4 rounded overflow-hidden border border-zinc-700">
            ...
            <div className="bg-zinc-900 text-zinc-300 p-3 font-mono text-[11px] leading-relaxed min-h-[120px]">
              {showTerminal && (
                <>
                  ...
                  {showInstalling && (
                    <div className="mt-2 text-zinc-500 animate-in fade-in duration-200">
    ...
    <PreviewFrame>
      <div className="text-xs">
        ...
        <div className="p-4">
          ...
          <div className="border-l-4 border-l-primary bg-background p-4 shadow-lg">
            ...
            <div className="space-y-2 mb-4">
              ...
              {keyAdded && (
                <div className="flex items-center justify-between p-2 bg-green-500/10 border border-green-500/20 animate-in fade-in slide-in-from-top-1 duration-200">
                  <div className="flex items-center gap-2">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <div className={`flex-1 border h-8 flex items-center px-2 font-mono text-[10px] transition-colors ${showInput && !keyAdded ? 'border-primary ring-1 ring-primary/20' : ''}`}>
                  {typingKey && !keyAdded && (
                    <span>
                      {keyText}
                  ...
                  {!typingKey && !keyAdded && (
                    <span className="text-muted-foreground">ssh-rsa AAAAB3... user@example.com</span>
                  )}
                </div>
      ...
      <div className="text-xs">
        ...
        <div className="p-4">
          ...
          <div className="border-l-4 border-l-primary bg-background p-4 shadow-lg">
            ...
            {/* SSH key display */}
            <div className={`relative bg-muted p-3 font-mono text-[10px] transition-all ${hoverCopy && !copied ? 'ring-1 ring-primary/30' : ''}`}>
              {showKey && (
                <pre className="m-0 overflow-x-auto text-foreground animate-in fade-in duration-300">
                  {sshKey}
                </pre>
              )}
            ...
            {copied && (
              <p className="text-green-600 text-[10px] mt-2 animate-in fade-in duration-200">
                Copied to clipboard!
              </p>
            )}

            <div className="mt-4 p-3 bg-muted/50 border">
