...
export function WebsiteHeader({ currentPage, alwaysShowBorder = false }: WebsiteHeaderProps) {
  ...
  return (
    <>
      ...
      <header
        className={cn(
          'bg-background/95 sticky top-0 z-50 border-b backdrop-blur-sm transition-colors duration-200',
      ...
      >
        <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              className="text-foreground/50 hover:text-foreground hidden transition-colors md:block"
              aria-label="GitHub"
            >
            ...
            <button
              className="text-foreground/60 hover:text-foreground -mr-2 p-2 md:hidden"
        ...
        {/* Mobile menu */}
        {mobileMenuOpen && (
          <div className="border-foreground/10 border-t md:hidden">
            <div className="space-y-1 px-6 py-4">
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-foreground/50 hover:text-foreground block py-2.5 text-sm transition-colors"
                onClick={handleMobileMenuClose}
              >
                GitHub
              </Link>
