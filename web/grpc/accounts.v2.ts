...
export type AccountsV2Service = typeof AccountsV2Service;
export const AccountsV2Service = {
  getAccountDetails: {
    path: "/AccountsV2/GetAccountDetails",
    requestStream: false,
  ...
  checkAccountNameAvailability: {
    path: "/AccountsV2/CheckAccountNameAvailability",
    requestStream: false,
    responseStream: false,
  ...
  disableAccount: {
    path: "/AccountsV2/DisableAccount",
    requestStream: false,
    responseStream: false,
...
export interface AccountsV2Server extends UntypedServiceImplementation {
...
export interface AccountsV2Client extends Client {
  getAccountDetails(
...
export const AccountsV2Client = makeGenericClientConstructor(AccountsV2Service, "AccountsV2") as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): AccountsV2Client;
  service: typeof AccountsV2Service;
  serviceName: string;
};
