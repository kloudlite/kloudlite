  ...
  return (
    <div className="prose prose-slate dark:prose-invert mx-auto max-w-3xl px-4 pt-8 pb-16 sm:px-6 lg:px-8 xl:pr-16">
      ...
      <section className="mb-12 sm:mb-16">
        <h2 className="text-foreground mb-4 sm:mb-6 text-2xl sm:text-3xl font-bold">Quick Start</h2>
        <div className="bg-card rounded-lg border p-4 sm:p-6">
          <h3 className="text-card-foreground mb-3 sm:mb-4 text-lg sm:text-xl font-semibold leading-snug">
          ...
          <ol className="space-y-4">
            <li className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-card-foreground font-medium leading-snug">Check workspace status</p>
            ...
            <li className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-card-foreground font-medium leading-snug">Install packages you need</p>
            ...
            <li className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-card-foreground font-medium leading-snug">Start coding</p>
      ...
      {/* Key Features */}
      <section className="mb-12 sm:mb-16">
        <h2 className="text-foreground mb-4 sm:mb-6 text-2xl sm:text-3xl font-bold">Key Features</h2>
        <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
          ...
          <div className="bg-card rounded-lg border p-4 sm:p-6">
            ...
            <h3 className="text-card-foreground mb-2 text-xl font-semibold leading-snug">Package Management</h3>
            <p className="text-muted-foreground leading-relaxed">
      ...
      {/* Core Concepts */}
      <section className="mb-12 sm:mb-16">
        <h2 className="text-foreground mb-4 sm:mb-6 text-2xl sm:text-3xl font-bold">Core Concepts</h2>
        <div className="space-y-4 sm:space-y-6">
          <div className="bg-card rounded-lg border p-4 sm:p-6">
            <h3 className="text-card-foreground mb-3 text-xl font-semibold leading-snug">Workspaces</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="bg-card rounded-lg border p-4 sm:p-6">
            <h3 className="text-card-foreground mb-3 text-xl font-semibold leading-snug">Environments</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="bg-card rounded-lg border p-4 sm:p-6">
            <h3 className="text-card-foreground mb-3 text-xl font-semibold leading-snug">Service Intercepts</h3>
            <p className="text-muted-foreground leading-relaxed">
      ...
      {/* CLI Commands */}
      <section className="mb-12 sm:mb-16">
        <h2 className="text-foreground mb-4 sm:mb-6 text-2xl sm:text-3xl font-bold">Common CLI Commands</h2>
      ...
      {/* Deployment Options */}
      <section className="mb-12 sm:mb-16">
        <h2 className="text-foreground mb-4 sm:mb-6 text-2xl sm:text-3xl font-bold">Deployment Options</h2>
        <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
          <div className="bg-card rounded-lg border p-4 sm:p-6">
            <h3 className="text-card-foreground mb-3 text-lg font-semibold leading-snug">AWS</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Deploy Kloudlite on Amazon Web Services using EKS for managed Kubernetes.
            </p>
          </div>
          <div className="bg-card rounded-lg border p-4 sm:p-6">
            <h3 className="text-card-foreground mb-3 text-lg font-semibold leading-snug">Azure</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Run Kloudlite on Microsoft Azure using AKS for enterprise-grade deployments.
            </p>
          </div>
          <div className="bg-card rounded-lg border p-4 sm:p-6">
            <h3 className="text-card-foreground mb-3 text-lg font-semibold leading-snug">GCP</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
      ...
      <section className="mb-12 sm:mb-16">
        <div className="bg-card rounded-lg border p-6 sm:p-8 text-center">
          <h2 className="text-card-foreground mb-4 text-2xl font-bold leading-tight">Need Help?</h2>
