 ...
 *
 * Examples:
 *   - Get installation cert: /api/installations/download-certificates?installationKey=abc-123&format=json
 *   - Get workmachine cert: /api/installations/download-certificates?installationKey=abc-123&scope=workmachine&scopeIdentifier=dev1
 *   - Get workspace cert: /api/installations/download-certificates?installationKey=abc-123&scope=workspace&scopeIdentifier=workspace1&parentScopeIdentifier=dev1
 *
