...
export default ({ }) => {
    ...
    return <div className={classNames("flex flex-col items-center justify-center h-full")}>
        <form className={classNames("flex flex-1 flex-col items-center self-stretch justify-center px-3xl pb-5xl border-b border-border-default")} onSubmit={onsubmit}>
