...
const Tabs = () => {
  ...
  return (
    <CommonTabs
      baseurl={`/${account}/${project}/env/${environment}/router/${router}`}
      backButton={{
        label: 'Routers',
        to: `/${account}/${project}/env/${environment}/routers`,
      }}
      tabs={tabs}
    />
  );
...
export const loader = async (ctx: IRemixCtx) => {
  ...
  try {
    ...
    return redirect(`/${account}/${project}/env/${environment}/routers/`);
  }
};
