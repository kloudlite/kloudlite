...
function ResizableHandle({
  ...
  return (
    <ResizablePrimitive.PanelResizeHandle
      ...
      className={cn(
        "bg-border focus-visible:ring-ring relative flex w-px items-center justify-center transition-all duration-200 ease-in-out",
    ...
    >
      {withHandle && (
        <div className="bg-border z-10 flex h-4 w-3 items-center justify-center rounded-xs border transition-all duration-200 ease-in-out hover:bg-muted hover:border-primary/50 active:scale-95">
          <GripVerticalIcon className="size-2.5 transition-colors duration-200" />
        </div>
      )}
    </ResizablePrimitive.PanelResizeHandle>
  )
