  ...
  individualNodePools: [
    {
      ...
      cpuPerNode: 8,
      memoryPerNodeGB: 32,
      cpuCores: 64, // 8 nodes * 8 CPU per node
      memoryGB: 256, // 8 nodes * 32GB per node
      usedCpuCores: 32,
      usedMemoryGB: 128,
      cpuUtilization: 50.0,
      memoryUtilization: 50.0,
